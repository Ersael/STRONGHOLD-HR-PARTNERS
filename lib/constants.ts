...
/**
 * Minutos de tiempo límite por defecto por batería (Fase B), usados para
 * pre-rellenar el formulario de asignación (`AssignAssessmentForm.tsx`). El
 * admin puede cambiarlos antes de guardar; se persisten en
 * `candidate_assessments.time_limit_minutes` (columna agregada en Fase A,
 * default SQL 30, que solo aplica si no se manda un valor explícito).
 */
export const DEFAULT_TIME_LIMIT_MINUTES: Record<AssessmentCode, number> = {
  behavioral: 20,
  cognitive: 45,
  personality: 30,
  competencies: 25,
